...
class GrypeJsonParser(FindingParser):
    ...
    def _parse_match(self, m: dict[str, Any]) -> ParsedFinding | None:
        ...
        return ParsedFinding(
            ...
            compliance_tags=(),
            package_name=bounded_text(artifact.get("name"), 512),
            package_version=bounded_text(artifact.get("version"), 256),
            package_ecosystem=bounded_text(artifact.get("type"), 64),
            package_purl=bounded_text(artifact.get("purl"), 1024),
        )
