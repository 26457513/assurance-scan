...
class ConfigUpdateWorkflowTests(unittest.TestCase):
    def test_dashboard_discovers_all_installed_compliance_regimes_by_default(self) -> None:
        ...
        self.assertEqual({
            "resources/compliance-regimes/asvs/v5.0.0.json",
            "resources/compliance-regimes/iso-27001/2022.json",
            "resources/compliance-regimes/nist-800-53/5.2.0.json",
            "resources/compliance-regimes/owasp-top-10/2021.json",
        }, relative)
                ...
                "tbts": [
                    {
                        ...
                        "expected_evidence": [{"type": "test_result"}],
                    }
                ],
            }))
            pack_dir = report_dir / "generated-tests" / "VG_TEST_FRAMEWORK"
    ...
    def test_graph_materializes_planning_artifacts_and_blueprint_lineage(self) -> None:
            ...
            frs=[
                {
                    ...
                    "derived_from": {
                        ...
                        "source_path": "resources/blueprints/security-core/asvs-5.0.0/fr-catalog.blueprint.json",
        ...
        graph_manifest = {
            "planning_artifacts": {
                "commitments": [
                    {
                        "path": "resources/blueprints/security-core/asvs-5.0.0/fr-catalog.blueprint.json",
    ...
    def test_graph_manifest_freezes_accepted_config_by_content_hash(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            dashboard.write_graph_manifest(
                ...
                compliance_regime_paths=[REPO_ROOT / "resources" / "compliance-regimes" / "asvs" / "v5.0.0.json"],
