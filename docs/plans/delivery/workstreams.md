...
Status: in progress. The read-only, checksum-bound preflight slice is complete;
identity/session storage, account linking, transformation and rehearsals remain.
